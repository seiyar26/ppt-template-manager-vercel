...
function handleTemplates(req, res) {
  ...
  const allTemplates = [...predefinedTemplates, ...templatesFromUploads];
...
function handleAddTemplate(req, res) {
  ...
  // Pour ce prototype, on répond simplement avec le template créé
...
app.listen(PORT, () => {
  console.log(`
✅ Serveur API complet démarré sur http://localhost:${PORT}
